...
def showdata (request):
    if request.method == "POST":
        ...
        #     cursor.execute("INSERT INTO career_person (firstname, lastname, middlename, gender, dateofB) VALUES (%s, %s, %s, %s, %s)", (firstName, lastName, midName, gender, dateOfBirth))
...
def delete(request):
    _id = request.GET.get('id','')
    # with connection.cursor() as cursor:
         # cursor.execute("DELETE FROM career_person where id= %s", _id)
